...
namespace ICLSearchDetail.Web.DBManager.Service.Loans
{
    public class LoansSearchService
    {
        ...
        public string getBatchIds2(string neededDates2)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(ConfigurationManager.ConnectionStrings["EXPRESS_SBC_CONN"].ConnectionString))
                {
                    ...
                    ret = summaryBatchIdAndCnts2(loanBatchIdDataResult, neededDates2);
        ...
        public string summaryBatchIdAndCnts2(List<LoanBatchIdModel> loanBatchIds, String neededDates2)
        {
        ...
        public string getAllSummaryForExportAll(string neededDates2)
        {
            string[] arrDates;
            arrDates = neededDates2.Split('|');
